...
const AboutMe = () => {
    return (
        <div className="lg:w-2/3  p-8 rounded-lg shadow-lg" style={{backgroundColor: '#2b2c4a'}}>
            ...
            <p className="text-lg leading-relaxed mb-6">
                ...
                different areas of tech. While I&#39;m not some coding prodigy, I&#39;ve come to genuinely enjoy
                working on
